...
class CrazyflowBaseEnv(VectorEnv):
    ...
    def __init__(
        ...
        **kwargs: dict,
        ...
        self.states_to_exclude_from_obs = ["step", "device"]  # exclude pos from observation
        self._obs_size = 0
        ...
        self._obs_size -= 2  # exclude x-y position from observation
    ...
    def _rescale_action(action: Array, control_type: str) -> Array:
        ...
        if params is None:
            raise NotImplementedError(f"Rescaling not implemented for control type '{control_type}'")
    ...
    def _get_obs(self) -> Dict[str, jnp.ndarray]:
        ...
        pos_obs = getattr(self.sim.states, "pos")[..., -1]
